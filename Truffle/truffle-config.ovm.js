  ...
  */
  ...
  networks: {
    ...
    optimistic_kovan: {
      ...
      chain_id: 69,
      provider: function() {
        return new HDWalletProvider(kovanMnemonic, "https://optimism-kovan.infura.io/v3/"+ process.env.INFURA_KEY, 0, 1);
      }
    },
    ...
    optimistic_mainnet: {
      ...
      chain_id: 10,
      provider: function() {
        return new HDWalletProvider(mainnetMnemonic, "https://optimism-mainnet.infura.io/v3/" + process.env.INFURA_KEY, 0, 1);
      }
    }
